carControllers.controller('CarListCtrl', ['$scope', 'carServices','$window' ,
  function($scope, CarServices, $window) {
    ...
    var init = function(){
      ...
      CarServices.getCars().then(onGetPhonesSuccess, onGetPhonesFailure);
